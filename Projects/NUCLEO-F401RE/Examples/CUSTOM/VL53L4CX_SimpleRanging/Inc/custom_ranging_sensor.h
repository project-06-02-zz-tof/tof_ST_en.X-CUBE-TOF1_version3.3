...
#ifndef USE_CUSTOM_RANGING_VL53L4CX
...
#if (USE_CUSTOM_RANGING_VL53L4CX == 1U)
#define CUSTOM_VL53L4CX (0)
#endif

#define RANGING_SENSOR_VL53L4CX_ADDRESS     (VL53L4CX_DEVICE_ADDRESS)
#define RANGING_SENSOR_NB_TARGET_PER_ZONE   (VL53L4CX_NB_TARGET_PER_ZONE)
#define RANGING_SENSOR_MAX_NB_ZONES         (VL53L4CX_MAX_NB_ZONES)

#define RS_MULTI_TARGET_SHORT_RANGE		(VL53L4CX_PROFILE_SHORT)
#define RS_MULTI_TARGET_MEDIUM_RANGE	(VL53L4CX_PROFILE_MEDIUM)
#define RS_MULTI_TARGET_LONG_RANGE		(VL53L4CX_PROFILE_LONG)

#define RS_MODE_BLOCKING_CONTINUOUS     (VL53L4CX_MODE_BLOCKING_CONTINUOUS)
#define RS_MODE_BLOCKING_ONESHOT        (VL53L4CX_MODE_BLOCKING_ONESHOT)
#define RS_MODE_ASYNC_CONTINUOUS        (VL53L4CX_MODE_ASYNC_CONTINUOUS)
#define RS_MODE_ASYNC_ONESHOT           (VL53L4CX_MODE_ASYNC_ONESHOT)

#define CUSTOM_RANGING_INSTANCES_NBR    (USE_CUSTOM_RANGING_VL53L4CX)
