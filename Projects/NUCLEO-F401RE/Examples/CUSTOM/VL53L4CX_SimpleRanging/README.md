...
### <b>VL53L4CX_SimpleRanging example description</b>

This example application shows how to use the SATEL-VL53L4CX breakout board on a STM32 Nucleo board 
...
### <b>Hardware and Software environment</b>
  ...
  - This example runs on STM32 Nucleo boards with SATEL-VL53L4CX breakout board
  - Connect the SATEL-VL53L4CX pins to the following STM32 Nucleo board inputs:
    - XSDN <---> A1
    - GPIO1(INT) <---> A2
    - SDA <---> D14
    - SCL <---> D15
