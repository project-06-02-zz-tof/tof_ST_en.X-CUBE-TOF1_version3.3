...
#define VL53L4A1_hi2c                   (hi2c1)

#define VL53L4A1_I2C_SCL_GPIO_PORT      BUS_I2C1_SCL_GPIO_PORT
#define VL53L4A1_I2C_SCL_GPIO_PIN       BUS_I2C1_SCL_GPIO_PIN
#define VL53L4A1_I2C_SDA_GPIO_PORT      BUS_I2C1_SDA_GPIO_PORT
#define VL53L4A1_I2C_SDA_GPIO_PIN       BUS_I2C1_SDA_GPIO_PIN

#define VL53L4A1_I2C_Init               BSP_I2C1_Init
#define VL53L4A1_I2C_DeInit             BSP_I2C1_DeInit
#define VL53L4A1_I2C_WriteReg           BSP_I2C1_Send
#define VL53L4A1_I2C_ReadReg            BSP_I2C1_Recv
